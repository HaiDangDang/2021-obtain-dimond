...
class HSV():
    ...
    def __init__(self, env):
        ...
        hsv_bond['normal'] = {'tree': {}, 'tree_2': {}, 'tree_2_2': {}, 'mine': {}, 'land': {}, 'land_3': {}, 'tree_3': {},
                              'item': {}, 'land_2': {}, 'useless_tree': {}, 'animal': {}, 'monster': {}, 'land_5': {}}
        ...
        hsv_bond['normal']['land_2']['water_under'] = {'hMin': 115, 'sMin': 206, 'hMax': 127, 'sMax': 225, 'vMin': 7,
                                                       'vMax': 113}
        ...
        hsv_bond['normal']['land_3']['rock_dark_yellow'] = {'hMin': 13, 'sMin': 47, 'hMax': 27, 'sMax': 106, 'vMin': 0,
                                                            'vMax': 175}
        hsv_bond['normal']['land_3']['rock_dark_brown'] = {'hMin': 27, 'sMin': 23, 'hMax': 32, 'sMax': 62, 'vMin': 0,
                                                           'vMax': 175}
        ...
        hsv_bond['normal']['land']['grass_2'] = {'hMin': 35, 'sMin': 116, 'hMax': 41, 'sMax': 135, 'vMin': 20,
                                                 'vMax': 170}  # 40
        ...
        hsv_bond['normal']['tree_2_2']['chunk_1_brown'] = {'hMin': 13, 'sMin': 162, 'hMax': 19, 'sMax': 204, 'vMin': 0,
                                                           'vMax': 116}
        ...
        hsv_bond['normal']['tree']['leaf_4_extra_3'] = {'hMin': 29, 'sMin': 119, 'hMax': 41, 'sMax': 160, 'vMin': 12,
                                                        'vMax': 46}
        hsv_bond['normal']['tree']['leaf_4_extra_4'] = {'hMin': 37, 'sMin': 142, 'hMax': 44, 'sMax': 161, 'vMin': 41,
                                                        'vMax': 74}
        ...
        hsv_bond['normal']['tree_2']['inside_chunk_2'] = {'hMin': 5, 'sMin': 141, 'hMax': 12, 'sMax': 178, 'vMin': 8,
                                                          'vMax': 234}

        hsv_bond['normal']['useless_tree']['Cactus'] = {'hMin': 59, 'sMin': 216, 'hMax': 66, 'sMax': 226, 'vMin': 23,
                                                        'vMax': 137}
        ...
        self.hsv_bond = hsv_bond
        self.VMaxs_bond = VMaxs_bond
        self.SMaxs_bond = SMaxs_bond
        self.HMaxs_bond = HMaxs_bond
        self.HMins_bond = HMins_bond
        self.SMins_bond = SMins_bond
        self.VMins_bond = VMins_bond
